...
export default function Testimonial() {
     ...
     function animate(element: HTMLElement, animationName: string) {
     ...
     function scrollTo() {
          const cards : HTMLCollectionOf<Element> = document.getElementsByClassName("custom-testimonial-card");
          ...
          setInterval(() => { 
               if(index < cards.length) {
                    slideIn(cards[index] as HTMLElement);   
                    index++; 
               }
          }, 2000);
     }
